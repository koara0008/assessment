...
assessmentButton.onclick = () => {
    ...
    '&ref_src=twsrc%5Etfw';
    anchor.setAttribute('heer', hrefValue);
...
const answers = [
    '{userName}のいいところの声です。{userName}の特徴的な声は皆を惹きつけ、心に残ります。',
    ...
    '{userName}のいいところは自制心です。ヤバいと思ったときにしっかりと衝動を抑えられる{userName}が皆から評価されています。'
];
